...
python examGAN_data.py \
    --dataset=junyi --all_num_questions=683 --num_concepts=40 \
    --load_model=./saved_models/junyi/model19 --hidden_size=64 --num_layers=1 \
    --num_students=50 --num_class=100 \
    --mean=70 --std=15 --num_questions=100 --num_init_papers=1000
...
python main2.py --method=gan \
    --dataset=junyi --all_num_questions=683 --num_concepts=40 --train_data_file=gan/train_data.pkl \
    --epoch=200 --batch_size=32 --random_dim=100 --lr=0.001 --gan_save_path=./saved_models/junyi/exam_gan \
    --load_model=./saved_models/junyi/model19 --hidden_size=64 --num_layers=1 \
    --num_students=50 \
    --mean=70 --std=15 --num_questions=100 --num_init_papers=1000 \
    --save_paper=True --save_paper_path=./papers/
