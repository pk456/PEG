...
python main2.py --method=gan \
    --dataset=static --all_num_questions=154 --num_concepts=80 --train_data_file=gan/train_data.pkl \
    --epoch=200 --batch_size=32 --random_dim=100 --lr=0.001 --gan_save_path=./saved_models/static/exam_gan \
    --load_model=./saved_models/static/model19 --hidden_size=64 --num_layers=1 \
    --num_students=50 \
    --mean=70 --std=15 --num_questions=100 --num_init_papers=1000 \
    --save_paper=True --save_paper_path=./papers/
