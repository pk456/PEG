...
python main2.py --method=gan \
    # 数据集相关设置
    --dataset=c_filter2 --all_num_questions=15161 --num_concepts=116 --train_data_file=gan/train_data.pkl \
    # gan网络设置
    --epoch=200 --batch_size=32 --random_dim=100 --lr=0.001 --gan_save_path=./saved_models/c_filter2/exam_gan \
    # DKT网络相关设置
    --load_model=./saved_models/c_filter2/model19 --hidden_size=64 --num_layers=1 \
    # 班级试题相关设置
    --num_students=50 \
